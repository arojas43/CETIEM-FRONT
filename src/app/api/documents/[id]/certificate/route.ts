...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .logo { font-size:28px; font-weight:900; letter-spacing:-0.5px; color:#0a1628; }
    .logo span { color:#1d9e75; }
    .badge { background:#1d9e75; color:#fff; font-size:10px; font-weight:700; letter-spacing:2px; padding:6px 14px; border-radius:100px; text-transform:uppercase; }
    .title { text-align:center; margin-bottom:48px; }
    .title h1 { font-size:13px; font-weight:600; letter-spacing:3px; text-transform:uppercase; color:#64748b; margin-bottom:12px; }
    .title h2 { font-size:36px; font-weight:900; color:#0a1628; letter-spacing:-1px; }
    .company-box { background:#f1f5f9; border-radius:16px; padding:32px; margin-bottom:32px; }
    .company-box h3 { font-size:24px; font-weight:700; color:#0a1628; margin-bottom:6px; }
    .company-box p { font-size:13px; color:#64748b; }
    .grid { display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px; margin-bottom:32px; }
    .kpi { background:#f1f5f9; border-radius:12px; padding:20px; }
    .kpi label { font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:1.5px; color:#94a3b8; display:block; margin-bottom:6px; }
    .kpi .value { font-size:22px; font-weight:800; color:#1d9e75; }
    .kpi .sub { font-size:11px; color:#64748b; margin-top:2px; }
    .vlap { margin-bottom:32px; }
    .vlap h4 { font-size:11px; font-weight:700; letter-spacing:2px; text-transform:uppercase; color:#94a3b8; margin-bottom:12px; }
    .vlap-row { display:flex; justify-content:space-between; align-items:center; padding:10px 16px; background:#f8fafc; border-radius:8px; margin-bottom:6px; }
    .vlap-row span { font-size:12px; color:#334155; }
    .vlap-check { color:#1d9e75; font-weight:700; font-size:13px; }
    .hash-box { background:#0a1628; border-radius:12px; padding:20px 24px; margin-bottom:32px; }
    .hash-box label { font-size:10px; font-weight:600; text-transform:uppercase; letter-spacing:1.5px; color:#64748b; display:block; margin-bottom:8px; }
    .hash-box code { font-family:monospace; font-size:11px; color:#1d9e75; word-break:break-all; }
    .footer { border-top:1px solid #e2e8f0; padding-top:24px; display:flex; justify-content:space-between; align-items:flex-end; }
    .footer .seal { font-size:11px; color:#94a3b8; }
    .footer .issued { text-align:right; }
    .footer .issued strong { display:block; font-size:13px; color:#0a1628; font-weight:700; }
    .footer .issued span { font-size:11px; color:#94a3b8; }
    .watermark { position:absolute; bottom:80px; right:64px; opacity:0.04; font-size:80px; font-weight:900; color:#1d9e75; transform:rotate(-15deg); pointer-events:none; }
    @media print { body{background:#fff;} .page{margin:0;padding:48px;} }
  </style>
</head>
<body>
<div class="page">
  <div class="watermark">CETIEM</div>

  <div class="header">
    <div class="logo">CETIEM<span>.</span>S.C.</div>
  ...
  <div class="footer">
    <div class="seal">
      ...
      <div>Assessor: ${req?.assessorEmail || "CETIEM"}</div>
    </div>
    <div class="issued">
